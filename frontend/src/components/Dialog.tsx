...
/** Die offenen Fenster, das oberste zuletzt. Escape schliesst nur das oberste. */
const openDialogs: object[] = []

/** Fenster wie in nexcrate. Escape und ein Klick daneben schliessen, das Kreuz ist der sichtbare Ausgang. */
export function Dialog({
  ...
  // Nicht als Abhaengigkeit: Sonst liefe der Effekt bei jedem Zeichnen und holte den Fokus aus dem Feld.
